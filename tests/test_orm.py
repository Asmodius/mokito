...
class ORMTestCase(AsyncTestCase):
    ...
    def test_from_json_1(self):
        ...
        self.assertDictEqual(d.value, {
            'f1': [45602, 'foo3'],
            'f2': {'a': 11, 'b': 12},
            'm1': {'x2': [u.dt11, u.dt12], 'x3': [7, 'z3'], 'x1': 0.2, 'x4': {'a': 8, 'b': 8}},
            'm2': [{'x2': [u.xt1], 'x3': [8, 'z1'], 'x1': 0.2, 'x4': {'a': 9, 'b': 9}},
                   {'x2': [u.xt2, u.xt3], 'x3': [9, 'z2'], 'x1': 0.3, 'x4': {'a': 10, 'b': 10}}],
            'd2': [{'x2': [u.dt4, u.dt5, u.dt6], 'x3': [45601, u'z2'], 'x1': 1.5, 'x4': {'a': 3, 'b': 4}}],
            'd1': {'x2': [u.dt4, u.dt5, u.dt6], 'x3': [45601, u'z2'], 'x1': 1.5, 'x4': {'a': 3, 'b': 4}}
        })
